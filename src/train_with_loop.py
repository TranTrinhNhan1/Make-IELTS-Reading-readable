...
def train_manual_with_wandb():
    ...
    global_step = 0 # Biến đếm số lần cập nhật trọng số
    ...
    for epoch in range(NUM_EPOCHS):
        ...
        print(f"Epoch {epoch+1} | BLEU: {metrics['bleu']:.2f} | ROUGE-L: {metrics['rougeL']:.4f}")

        wandb.log({
            "eval/bleu": metrics['bleu'],
            "eval/rouge1": metrics['rouge1'],
            "eval/rouge2": metrics['rouge2'],
            "eval/rougeL": metrics['rougeL'], 
